""" sampling and subsampling functions """
# =============================================================================
# Imports
# =============================================================================
...
def subsample(dataset, subsample_size=10, subsample_method=1, path=os.getcwd(), outputpath=os.getcwd(), verbose=True, subsample=[]):
    """
    ...
    return np.array(output_subsample).flatten(), subsample_path, bins_path
